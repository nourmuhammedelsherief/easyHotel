...
use App\Http\Resources\Hotel\SubscriptionResource;
...
class HotelResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'logo' => $this->logo == null ? null : asset('public/uploads/logo/' . $this->logo),
            ...
            'subscription' => $this->subscription == null ? null : new SubscriptionResource($this->subscription),
